...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',      # docker-compose의 POSTGRES_DB
        'USER': 'postgres',      # docker-compose의 POSTGRES_USER
        'PASSWORD': 'postgres',  # docker-compose의 POSTGRES_PASSWORD
...
CELERY_TIMEZONE = 'Asia/Seoul' # 혹은 UTC

REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.SessionAuthentication', # 웹 브라우저용 (Admin 등)
        'rest_framework.authentication.BasicAuthentication',   # [중요] API/확장프로그램용
    ],
